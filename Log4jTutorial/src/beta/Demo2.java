...
public class Demo2 {
	// log all info for Demo2
	public static Logger log= LogManager.getLogger(Demo2.class.getName());

	public static void main(String[] args) throws InterruptedException {
		// TODO Auto-generated method stub
		   log.debug("Demo2:The button has been clicked");
		   log.info("Demo2:The button is displayed");
		   log.error("Demo2:The button is not displayed");
		   log.fatal("Demo2:The button is missing");
